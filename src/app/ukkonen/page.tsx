    ...
    return (
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center gap-6 relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="absolute top-[-20%] right-[-10%] w-150 h-150 rounded-full bg-amber-500/3 blur-[120px]" />
          <div className="absolute bottom-[10%] left-[-10%] w-100 h-100 rounded-full bg-amber-500/[0.02] blur-[100px]" />
        </div>
